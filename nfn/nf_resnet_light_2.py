...
def nf_light_2_0(base_conv: nn.Conv2d = ScaledStdConv2d, dropout_p: float = 0.2, alpha:float = 0.2, **kwargs):
    return _nf_resnet('f0', BasicBlock, [1, 2, 6, 3], False, base_conv=base_conv, dropout_p=dropout_p, alpha=alpha, **kwargs)

def nf_light_2_1(base_conv: nn.Conv2d = ScaledStdConv2d, dropout_p: float = 0.3, alpha: float = 0.2, **kwargs):
    return _nf_resnet('f1', BasicBlock, [2, 4, 12, 6], False, base_conv=base_conv, dropout_p=dropout_p, alpha=alpha, **kwargs)

def nf_light_2_2(base_conv: nn.Conv2d = ScaledStdConv2d, dropout_p: float = 0.4, alpha: float = 0.2, **kwargs):
    return _nf_resnet('f1', BasicBlock, [3, 6, 18, 9], False, base_conv=base_conv, dropout_p=dropout_p, alpha=alpha, **kwargs)

def nf_light_2_3(base_conv: nn.Conv2d = ScaledStdConv2d, dropout_p: float = 0.4, alpha: float = 0.2, **kwargs):
    return _nf_resnet('f1', BasicBlock, [4, 8, 24, 12], False, base_conv=base_conv, dropout_p=dropout_p, alpha=alpha, **kwargs)

def nf_light_2_4(base_conv: nn.Conv2d = ScaledStdConv2d, dropout_p: float = 0.5, alpha: float = 0.2, **kwargs):
    return _nf_resnet('f1', BasicBlock, [5, 10, 30, 15], False, base_conv=base_conv, dropout_p=dropout_p, alpha=alpha, **kwargs)

def nf_light_2_5(base_conv: nn.Conv2d = ScaledStdConv2d, dropout_p: float = 0.5, alpha: float = 0.2, **kwargs):
    return _nf_resnet('f1', BasicBlock, [6, 12, 36, 18], False, base_conv=base_conv, dropout_p=dropout_p, alpha=alpha, **kwargs)

def nf_light_2_6(base_conv: nn.Conv2d = ScaledStdConv2d, dropout_p: float = 0.5, alpha: float = 0.2, **kwargs):
