...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv2 = conv3x3(width, width, stride, groups, dilation, base_conv=base_conv)
        self.conv3 = conv1x1(width, planes * self.expansion, base_conv=base_conv)
        self.gelu = nn.GELU()
        self.downsample = downsample
        self.stride = stride
        self.beta = beta
